...
void print_matrix(vector<vector<T> >& matrix)
{
	...
	typename vector<vector<T> >::iterator vvi_iterator;
	typename vector<T>::iterator vi_iterator;
...
int main()
{
	...
	cout << "******************************BATCH 1************************************" << endl;
	OptionData myOptionCallBatch1((OptionParams::assetPrice = 60, OptionParams::strike = 65, OptionParams::expiration = 0.25, OptionParams::interestRate = 0.08,
	...
	OptionData myOptionPutBatch1((OptionParams::assetPrice = 60, OptionParams::strike = 65, OptionParams::expiration = 0.25, OptionParams::interestRate = 0.08,
		OptionParams::volatility = 0.3, OptionParams::dividend = 0.0,
		OptionParams::foreignFreeInterestRate = 0.0, OptionParams::optionType = -1, OptionParams::underlyingAssetType = 1));
