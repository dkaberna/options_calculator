...
namespace DevonKaberna
{
	...
	{
		template <typename T>
		NormalDistribution<T>::NormalDistribution() : StatisticalDistribution<T>(), m_normal(new normal_distribution<T>()) {}   // Default constructor
		...
		template <typename T>
		NormalDistribution<T>::NormalDistribution(const T& _start_mean, const T& _start_stdev) : StatisticalDistribution<T>(_start_mean, _start_stdev), m_normal(new normal_distribution<T>(_start_mean, _start_stdev)) {}

		template <typename T>
		NormalDistribution<T>::NormalDistribution(const NormalDistribution<T>& source) : StatisticalDistribution<T>(source) { Copy(source); }	// Copy constructor
